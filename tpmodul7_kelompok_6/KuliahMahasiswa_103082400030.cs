...
{
    public class MataKuliah103082400030
    {
        public string kode_mata_kuliah;
        public string nama_mata_kuliah;
    }

    internal class KuliahMahasiswa_103082400030
    {
        public void ReadJSON()
        {
            string filename = "tp7_2_103082400030.json";
            ...
            try
            {
                ...
                List<MataKuliah103082400030> daftarMatkul =
                    JsonSerializer.Deserialize<List<MataKuliah103082400030>>(json, options);
